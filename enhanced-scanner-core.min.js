    ...
    window.EnhancedScanner = {
        ...
        handleReportContactFormSubmit: function (e, form) {
            ...
            if (!this.isValidSwedishPhone(phoneRaw)) {
                ...
                if (phoneErr) {
                    phoneErr.textContent = "Vänligen ange ett giltigt svenskt telefonnummer (t.ex. 070-123 45 67 eller +46 70 123 45 67).";
        ...
        /** Swedish numbers: E.164 +46 + 9 digits, or national 0 + 9 digits, or 9-digit mobile 7[02369]… */
        isValidSwedishPhone: function (raw) {
            let d = String(raw).replace(/\D/g, "");
            if (d.startsWith("00")) d = d.slice(2);
            if (d.startsWith("46") && d.length === 11) return /^46\d{9}$/.test(d);
            if (d.startsWith("0") && d.length === 10) {
                d = "46" + d.slice(1);
                return /^46\d{9}$/.test(d);
            }
            if (d.length === 9 && /^7[02369]\d{7}$/.test(d)) {
                d = "46" + d;
                return /^46\d{9}$/.test(d);
            }
            return false;
